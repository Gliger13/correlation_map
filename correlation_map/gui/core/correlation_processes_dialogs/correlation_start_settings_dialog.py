...
from correlation_map.core.config.correlation import CorrelationSettings, PreprocessorActions
...
class CorrelationStartSettingsDialog(QDialog):
    ...
    def __configure_correlation_type_radio_buttons(self) -> Dict[CorrelationTypes, QRadioButton]:
        ...
        for correlation_type in CorrelationTypes:
            radio_button = QRadioButton(correlation_type.value.replace("_", " ").capitalize())
    ...
    @log_configuration_process
    def __configure_correlation_settings_spin_boxes(self) -> dict[CorrelationTypes, QSpinBox]:
        ...
        correlation_settings_widgets_map: dict[CorrelationTypes, QSpinBox] = {}
